  ...
  return (
    <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gradient-to-br from-[#EAF8ED]/50 to-[#EAF8ED]/20 border border-[#34C759]/30 p-4 rounded-xl flex items-center justify-between shadow-2xs">
            <div className="space-y-1">
              ...
              <div className="flex items-baseline space-x-2">
                <span className="text-2xl font-extrabold text-[#1D1D1F]">{totalShopLiveCompleted}</span>
          ...
          <div className="bg-gradient-to-br from-purple-50/50 to-purple-50/20 border border-purple-300/40 p-4 rounded-xl flex items-center justify-between shadow-2xs">
            <div className="space-y-1">
              ...
              <div className="flex items-baseline space-x-2">
                <span className="text-2xl font-extrabold text-[#1D1D1F]">{totalActiveQueue}</span>
        ...
        {filteredTechStats.map((stats) => {
          ...
          return (
            <div
              ...
              className="bg-white border border-[#E5E5EA] hover:border-[#0071E3]/40 rounded-2xl p-5 shadow-xs hover:shadow-md transition-all space-y-5 flex flex-col justify-between cursor-pointer group"
            >
              ...
              <div className="space-y-3 pb-3 border-b border-[#E5E5EA]">
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-extrabold text-sm text-[#1D1D1F] flex items-center gap-1.5 group-hover:text-[#0071E3] transition-colors">
                        <span>{tech.name}</span>
              ...
              <div className="grid grid-cols-3 gap-2 py-1 text-center bg-[#F8F9FA] p-3 rounded-xl border border-[#E5E5EA]">
                ...
                <div className="space-y-0.5">
                  ...
                  <span className="block text-lg font-extrabold text-[#1D1D1F]">{liveCompleted}</span>
                  <span className="block text-[10px] text-[#86868B] font-bold">Baseline {baselineMonthly}/mo</span>
                </div>
                ...
                <div className="space-y-0.5 border-x border-[#E5E5EA] px-1">
                  ...
                  <span className="block text-lg font-extrabold text-[#1D1D1F]">
              ...
              {baselineMonthly > 0 ? (
                ...
                <div className="space-y-1.5">
                  <span className="text-[10px] text-[#86868B] font-bold uppercase tracking-wider flex items-center gap-1">
                    <TrendingUp className="w-3.5 h-3.5 text-[#0071E3]" />
                    This Period Completions
                  </span>
                  <span className="text-xs font-bold text-[#1D1D1F]">{liveCompleted} completed · no baseline set</span>
                </div>
              )}
                  ...
                  <div className="space-y-1.5 max-h-[140px] overflow-y-auto pr-1">
                    {activeOrders.slice(0, 3).map((wo) => (
                      <div
                        ...
                        className="p-2 bg-[#F8F9FA] hover:bg-white border border-[#E5E5EA] hover:border-[#0071E3]/40 rounded-lg flex items-center justify-between text-xs cursor-pointer transition-all group/ticket"
                      >
                        <div className="min-w-0 pr-2">
                          <p className="font-mono font-bold text-[#0071E3] group-hover/ticket:underline text-[11px] truncate">
                            {wo.orderNumber}
                          </p>
              ...
              <button
                ...
                className="w-full py-2 bg-[#F0F6FF] hover:bg-[#0071E3] text-[#0071E3] hover:text-white font-bold text-xs rounded-xl border border-[#0071E3]/20 flex items-center justify-center space-x-1 transition-all cursor-pointer"
              >
      ...
      {filteredTechStats.length === 0 && (
        <div className="bg-white border border-dashed border-[#D2D2D7] rounded-2xl p-10 text-center text-xs text-[#86868B] space-y-1">
          <Users className="w-6 h-6 mx-auto opacity-50" />
          <p className="font-extrabold text-sm text-[#1D1D1F]">No technicians found</p>
