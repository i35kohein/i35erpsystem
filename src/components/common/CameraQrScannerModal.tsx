        ...
        <div className="p-6 overflow-y-auto space-y-4 flex-1 text-xs">
          ...
          {activeTab === 'upload' && (
            <div className="p-8 border-2 border-dashed border-line hover:border-brand rounded-3xl text-center space-y-4 bg-surface transition-all">
              ...
              {errorMsg && (
                <p className="text-danger text-xs font-bold pt-2 flex items-center justify-center space-x-1">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-success-deep font-bold">Ready to auto-fill into Intake / Lookup</p>
                  </div>
                </div>
