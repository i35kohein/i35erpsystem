      ...
      >
        ...
        <div className="space-y-3">
          {itemName && (
            <div className="p-3.5 bg-surface border border-line rounded-2xl">
              <span className="block text-xs font-bold text-muted uppercase tracking-wider mb-0.5">Selected Item</span>
              <span className="block font-black text-sm text-ink break-words">{itemName}</span>
            </div>
          )}
        ...
        <div className="flex items-center justify-end space-x-3 pt-2">
          <Button
            ...
            onClick={onClose}
            variant="secondary"
            className="bg-surface hover:bg-line text-muted"
          >
            Cancel
          </Button>
          <Button
