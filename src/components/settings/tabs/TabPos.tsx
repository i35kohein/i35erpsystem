          ...
          <div className="bg-white rounded-2xl border border-line-strong shadow-2xs overflow-hidden">
              ...
              <div className="flex min-w-0 items-start space-x-3.5">
                ...
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-1.5">
                    ...
                    <span className="rounded-full bg-success/10 px-1.5 py-0.5 text-xs font-extrabold text-success-deep">Shop Settings source</span>
                  </div>
            ...
            <div className="bg-white p-5 rounded-2xl border border-line-strong shadow-2xs space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="w-8 h-8 rounded-lg bg-success/10 text-success flex items-center justify-center font-bold group-hover:bg-brand/10 group-hover:text-brand-deep transition-all">
                      <Tag className="w-4 h-4" />
                    </div>
                    <span className="px-2 py-0.5 rounded-full text-xs font-extrabold bg-surface text-muted border border-line">
                      Intake Tag
                    </span>
                  </div>
                  <div>
                  ...
                  <div className="pt-1 flex items-center space-x-2 text-xs font-bold text-muted group-hover:text-brand">
