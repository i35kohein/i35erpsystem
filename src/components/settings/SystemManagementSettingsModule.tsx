...
import { RECEIPT_FOOTER_ALIGNMENT_OPTIONS, RECEIPT_FOOTER_SIZE_OPTIONS, splitFooterTextBySize, getSelectedFooterLineIndexes, SAMPLE_PRINT_WORK_ORDER } from './settingsUtils';
