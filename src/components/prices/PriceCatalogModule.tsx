  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden">
      ...
      <div className="z-20 shrink-0 bg-[#F5F5F7] pt-1 pb-1">
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur border border-[#E5E5EA] rounded-xl px-2.5 py-1.5 flex items-center gap-2 shadow-2xs">
          ...
          <button
            ...
            className="shrink-0 px-2.5 py-1.5 bg-[#F5F5F7] hover:bg-[#E5E5EA] text-[#0071E3] font-extrabold text-[11px] rounded-lg border border-[#E5E5EA] transition-all flex items-center space-x-1 cursor-pointer active:scale-95"
          >
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-5 overflow-y-auto pb-16 lg:pb-0 lg:grid lg:grid-cols-12 lg:overflow-hidden [scrollbar-gutter:stable]">
        ...
        <div className="hidden lg:flex flex-col overflow-hidden rounded-2xl border border-[#E5E5EA] bg-white shadow-2xs lg:col-span-4 lg:h-full lg:min-h-0 lg:overflow-y-auto">
          {/* Cart Header */}
      ...
      {isCartSheetOpen && (
        ...
        >
          ...
          >
            {/* Sheet Header */}
            <div className="shrink-0 p-4 border-b border-[#E5E5EA] flex items-center justify-between bg-[#F5F5F7]/80">
              <div className="flex items-center space-x-2.5 min-w-0">
                <div className="w-8 h-8 rounded-xl bg-[#0071E3]/10 text-[#0071E3] flex items-center justify-center shrink-0">
                  <Receipt className="w-4 h-4" />
                </div>
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                ...
                <button
                  ...
                  className="w-9 h-9 flex items-center justify-center rounded-lg bg-[#F5F5F7] text-[#1D1D1F] hover:bg-[#E5E5EA] transition-colors cursor-pointer"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
            ...
            {/* Safe-area spacer for the grab area */}
