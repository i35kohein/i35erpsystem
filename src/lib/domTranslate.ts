...
const DICT: [string, string][] = [
  ...
  ['Finished', 'ပြီးစီး'],
  ['Taken Out', 'ထုတ်ယူပြီး'],
  ["Can't Repair", 'ပြင်ဆင်၍မရပါ'],
  ['Customer Not Repair', 'ဝယ်ယူသူ ပြင်မလို'],
  ['Customer Cancelled', 'ဝယ်ယူသူ ပယ်ဖျက်'],
  ['Urgent', 'အရေးပေါ်'],
  ['Normal', 'သာမန်'],
  ['B2B Priority', 'B2B ဦးစားပေး'],
  ['Warranty Redo', 'အာမခံ ပြန်ပြုပြင်ရန်'],
  ...
  ['Retail Walk-In', 'လက်လီ ဝင်လာသူ'],
  ['B2B Corporate Account', 'B2B ကုမ္ပဏီ အကောင့်'],
  ['Wholesale Mail-In Partner', 'လက်ကား စာပို့ ဖောက်သည်'],
  ...
  ['Cash', 'ငွေသား'],
  ['Credit Card', 'ကတ်ဖြင့် ပေးချေမှု'],
  ['Bank Transfer', 'ဘဏ်လွှဲ'],
  ['Mobile Payment', 'မိုဘိုင်း ငွေပေးချေမှု'],
