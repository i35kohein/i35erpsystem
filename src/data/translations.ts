...
export const translations: TranslationDictionary = {
  ...
  navQa: { en: 'QA & Warranty', mm: 'စစ်ဆေးရေးနှင့် အာမခံ စစ်ဆေးမှု' },
  navFollowUp: { en: 'Follow-Ups', mm: 'ဝယ်ယူသူ ဆက်သွယ်စုံစမ်းရေး' },
  navPartsMatrix: { en: 'Inventory', mm: 'အပိုပစ္စည်းနှင့် စတော့စာရင်း Matrix' },
  navSuppliers: { en: 'Suppliers & RMAs', mm: 'ပစ္စည်းပေးသွင်းသူနှင့် အာမခံ ပြန်အပ်လွှဲ' },
  navPos: { en: 'POS & Invoicing', mm: 'အရောင်းနှင့် ဘေလ်ဖြတ်ပိုင်း ပေါ်တယ်' },
  navDevices: { en: 'Devices Management', mm: 'စက်ပစ္စည်းများ စီမံခန့်ခွဲမှု' },
  navCrm: { en: 'Customers & Staff', mm: 'ဝယ်ယူသူနှင့် ဝန်ထမ်း ပေါ်တယ်' },
  navMicroSoldering: { en: 'Micro-Soldering Lab', mm: 'မိုက်ခရို ဂဟေဆက်ဓာတ်ခွဲခန်း' },
  navSettings: { en: 'Settings', mm: 'စနစ် စီမံခန့်ခွဲမှု' },
